...
revise_limits_patchwork = function(plot, xlim_low, xlim_high, ylim_low, ylim_high, ylim_coverage_low, ylim_coverage_high){
  plot[[1]] = suppressMessages(plot[[1]] + ggplot2::xlim(c(xlim_low, xlim_high)) + ggplot2::ylim(ylim_low, ylim_high))
  plot[[2]] = suppressMessages(plot[[2]] + ggplot2::xlim(c(xlim_low, xlim_high)) +
